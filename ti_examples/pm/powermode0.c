...
/***********************************************************************************
  Filename:     powermode0.c

  Description:  Example describing how to enter Power Mode 0

  Comments:     This code example shows how to correctly enter Power Mode 0 and
                wake up using an External Interrupt.
                The example uses Button 1 (S1) on SMARTRF04EB to generate the
                External Interrupt. For test purpose, LED 1 is used to show when
                the SoC enters and exits PM0.
...
* @fn          main
*
* @brief       Entering Power Mode 0 using external port
*
* @param       void
*
* @return      0
...
int main(void)
{
     ...
     * For PM0 both the HS RCOSC and HS XOSC can be used.
     */
    ...
    do
    {
        ...
        // The SoC is now in PM0 and will only wake up upon any
